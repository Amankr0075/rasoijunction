...
const Sidebar = () => {
  ...
  return (
    ...
    >
      {/* Logo */}
      <div className="h-20 flex items-center px-4 border-b border-gray-100 dark:border-dark-700/50">
      ...
      <div className="border-t border-gray-100 dark:border-dark-700/50 p-3">
        ...
        {user && (
          <button
            onClick={logout}
            className={`w-full flex items-center gap-3 p-2.5 mb-2 rounded-xl text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 transition-colors font-medium text-sm ${
